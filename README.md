...
Kraken datasets for **sample-level** FastViFi for HPV virus are available on [https://drive.google.com/file/d/1QYn5lDWjvhtIWCrwmzDc_1fy8ANrXWz1/view?usp=sharing](https://drive.google.com/file/d/1YRniG4hs1FFqn8jtPfjgONhZHR1MtCa8/view?usp=share_link). After downloading the compressed file, run the following command to unpack:
...
Whether or not ViFi is installed locally, the human reference data file should be downloaded from [https://drive.google.com/file/d/1XBZbwgcV1n2AWWAyt2RWfSKKxzssRFBo/view?usp=share_link](https://drive.google.com/file/d/1iZQLul9Kor0KwD2sKDh-k3NgqJ0cmIHq/view?usp=share_link). If ViFi is locally installed, the downloaded file should be placed inside the ViFi directory. Otherwise, to run FastViFi with Docker or Singularity, the human reference directory should be passed to `run_kraken_vifi_container.py` with the `--vifi-human-ref-dir` argument.
